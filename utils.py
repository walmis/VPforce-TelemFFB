...
class EffectTranslator:
    def __init__(self):
        self.effect_dict = {
            ...
            "dynamic_spring" : ["Dynamic Spring Force", "aileron_spring_gain"],
            ...
            "fbw_spring" : ["Fly-by-wire Spring Force", "fbw_aileron_gain"],
            "flapsmovement" : ["Flap Motion", "flaps_motion_intensity"],
            "gearbuffet" : ["Gear Drag Buffeting", "gear_buffet_effect_enabled"],
            "gearbuffet2" : ["Gear Drag Buffeting", "gear_buffet_effect_enabled"],
            ...
            "prop_rpm0-1" : ["Propeller Engine Rumble", "engine_rumble_lowrpm_intensity" ],
