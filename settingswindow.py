...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.gridLayout.addWidget(self.drp_valuebox, 29, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_7, 33, 11, 1, 1)
        self.b_revert = QtWidgets.QPushButton(self.centralwidget)
        self.b_revert.setObjectName("b_revert")
        self.gridLayout.addWidget(self.b_revert, 46, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_getcurrentmodel, 36, 11, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem, 32, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.tb_currentmodel, 36, 6, 1, 5)
        ...
        self.gridLayout.addWidget(self.cb_show_inherited, 36, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_manual, 46, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_update, 30, 11, 1, 1)
        self.b_createusermodel = QtWidgets.QPushButton(self.centralwidget)
        self.b_createusermodel.setObjectName("b_createusermodel")
        self.gridLayout.addWidget(self.b_createusermodel, 36, 4, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setObjectName("label_8")
        self.gridLayout.addWidget(self.label_8, 34, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.buttonBox, 46, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.label, 36, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_4, 35, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.drp_device, 15, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.table_widget, 16, 0, 20, 11)
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_9.setObjectName("label_9")
        self.gridLayout.addWidget(self.label_9, 15, 10, 1, 1)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        item.setText(_translate("SettingsWindow", "New Column"))
        self.label_9.setText(_translate("SettingsWindow", "Change Device:"))
