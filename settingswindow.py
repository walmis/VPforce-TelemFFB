...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.l_device.setMaximumSize(QtCore.QSize(150, 16777215))
        ...
        self.gridLayout.addWidget(self.l_name, 19, 11, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setObjectName("label_8")
        self.gridLayout.addWidget(self.label_8, 33, 11, 1, 1)
        self.t_info = QtWidgets.QTextEdit(self.centralwidget)
        ...
        self.t_info.setMaximumSize(QtCore.QSize(16777215, 100))
        self.t_info.setAcceptDrops(False)
        self.t_info.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.t_info.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.t_info.setUndoRedoEnabled(False)
        self.t_info.setReadOnly(True)
        self.t_info.setObjectName("t_info")
        self.gridLayout.addWidget(self.t_info, 21, 11, 1, 1)
        self.line_3 = QtWidgets.QFrame(self.centralwidget)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout.addWidget(self.line_3, 17, 11, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout.addWidget(self.line_2, 20, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_browse, 27, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.table_widget, 16, 0, 19, 11)
        self.l_validvalues = QtWidgets.QLabel(self.centralwidget)
        self.l_validvalues.setObjectName("l_validvalues")
        self.gridLayout.addWidget(self.l_validvalues, 25, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_displayname, 18, 11, 1, 1)
        self.cb_enable = QtWidgets.QCheckBox(self.centralwidget)
        self.cb_enable.setObjectName("cb_enable")
        self.gridLayout.addWidget(self.cb_enable, 22, 11, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(150, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout.addWidget(self.tb_value, 24, 11, 1, 1)
        self.l_value = QtWidgets.QLabel(self.centralwidget)
        self.l_value.setObjectName("l_value")
        self.gridLayout.addWidget(self.l_value, 23, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.slider_float, 26, 11, 1, 1)
