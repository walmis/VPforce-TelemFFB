...
from telemffb.sim.AircraftEffectUtilsBase import AircraftEffectUtilsBase
...
class AircraftBase(GForceEffectMixIn, PedalSpringOverrideMixIn, BuffetingEffectMixIn):
    rotor_blade_count = 2
