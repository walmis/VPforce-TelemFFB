...
DINPUT_TOOLTIP = (
    ...
    "<p><b>DirectLink</b> is a separate project and must be installed "
...
class SystemSettingsDialog(QDialog, Ui_SystemDialog):
    def __init__(self, parent=None,):
        ...
        # moment the pointer moves, so a link in one can never be clicked.
        # The refusal dialog and the status line below carry the live link.
        self.cb_enable_dinput.setToolTip(
            DINPUT_TOOLTIP + f'<p>Get DirectLink at {BRIDGE_DOWNLOAD_LOCATION}</p>')
        # The status line names the same address; a QLabel opens links
        # only when told to.
        self.lab_dinput_status.setOpenExternalLinks(True)
