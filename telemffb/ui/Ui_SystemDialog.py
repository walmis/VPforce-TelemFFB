...
class Ui_SystemDialog(object):
    def setupUi(self, SystemDialog):
        ...
        self.buttonChildSettings.setGeometry(QtCore.QRect(150, 640, 171, 23))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(313, 45, 278, 106))
        ...
        self.lab_auto_launch = QtWidgets.QLabel(self.layoutWidget5)
        ...
        self.lab_start_min = QtWidgets.QLabel(self.layoutWidget5)
        ...
        self.lab_start_headless = QtWidgets.QLabel(self.layoutWidget5)
        ...
        self.rb_master_j = QtWidgets.QRadioButton(self.layoutWidget5)
        ...
        self.tb_pid_j = QtWidgets.QLineEdit(self.layoutWidget5)
        ...
        self.cb_al_enable_j = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_min_enable_j = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_headless_j = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.rb_master_p = QtWidgets.QRadioButton(self.layoutWidget5)
        self.rb_master_p.setObjectName("rb_master_p")
        self.gridLayout_2.addWidget(self.rb_master_p, 2, 0, 1, 1)
        self.tb_pid_p = QtWidgets.QLineEdit(self.layoutWidget5)
        ...
        self.cb_al_enable_p = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_min_enable_p = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_headless_p = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.rb_master_c = QtWidgets.QRadioButton(self.layoutWidget5)
        self.rb_master_c.setObjectName("rb_master_c")
        self.gridLayout_2.addWidget(self.rb_master_c, 3, 0, 1, 1)
        self.tb_pid_c = QtWidgets.QLineEdit(self.layoutWidget5)
        ...
        self.cb_al_enable_c = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_min_enable_c = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.cb_headless_c = QtWidgets.QCheckBox(self.layoutWidget5)
