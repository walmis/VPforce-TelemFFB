...
class Ui_SystemDialog(object):
    def setupUi(self, SystemDialog):
        ...
        SystemDialog.setMinimumSize(QtCore.QSize(600, 760))
        SystemDialog.setMaximumSize(QtCore.QSize(600, 760))
        self.line = QtWidgets.QFrame(SystemDialog)
        self.line.setGeometry(QtCore.QRect(6, 280, 581, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.buttonBox.setGeometry(QtCore.QRect(427, 727, 156, 23))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Save)
        self.buttonBox.setObjectName("buttonBox")
        self.resetButton = QtWidgets.QPushButton(SystemDialog)
        self.resetButton.setGeometry(QtCore.QRect(11, 727, 121, 23))
        self.resetButton.setObjectName("resetButton")
        self.layoutWidget = QtWidgets.QWidget(SystemDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(17, 40, 221, 137))
        ...
        self.line_2.setGeometry(QtCore.QRect(7, 567, 581, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.labelSystem.setGeometry(QtCore.QRect(17, 10, 141, 16))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.labelSim.setGeometry(QtCore.QRect(17, 298, 151, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        ...
        self.labelOther.setGeometry(QtCore.QRect(17, 580, 181, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        ...
        self.label_8.setGeometry(QtCore.QRect(27, 600, 101, 16))
        self.label_8.setObjectName("label_8")
        self.layoutWidget1 = QtWidgets.QWidget(SystemDialog)
        self.layoutWidget1.setGeometry(QtCore.QRect(33, 620, 184, 48))
        ...
        self.label_10.setGeometry(QtCore.QRect(272, 148, 151, 16))
        self.label_10.setObjectName("label_10")
        self.line_3 = QtWidgets.QFrame(SystemDialog)
        self.line_3.setGeometry(QtCore.QRect(240, 13, 20, 261))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_13.setGeometry(QtCore.QRect(207, 598, 191, 20))
        self.label_13.setObjectName("label_13")
        self.layoutWidget2 = QtWidgets.QWidget(SystemDialog)
        self.layoutWidget2.setGeometry(QtCore.QRect(219, 620, 371, 80))
        ...
        self.browseVPConfStartup = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.enableVPConfStartup = LabeledToggle(self.layoutWidget2)
        self.enableVPConfStartup.setObjectName("enableVPConfStartup")
        self.gridLayout_4.addWidget(self.enableVPConfStartup, 0, 0, 1, 1)
        self.browseVPConfExit = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.pathVPConfExit = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.pathVPConfStartup = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.enableVPConfExit = LabeledToggle(self.layoutWidget2)
        ...
        self.enableVPConfGlobalDefault = LabeledToggle(self.layoutWidget2)
        ...
        self.enableMSFS = LabeledToggle(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.enableXPLANE = LabeledToggle(self.layoutWidget3)
        ...
        self.validateXPLANE = LabeledToggle(self.layoutWidget3)
        ...
        self.lab_pathXPLANE = QtWidgets.QLabel(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pathXPLANE = QtWidgets.QLineEdit(self.layoutWidget3)
        self.pathXPLANE.setObjectName("pathXPLANE")
        self.horizontalLayout_2.addWidget(self.pathXPLANE)
        self.browseXPLANE = QtWidgets.QToolButton(self.layoutWidget3)
        ...
        self.enableIL2 = LabeledToggle(self.layoutWidget3)
        ...
        self.validateIL2 = LabeledToggle(self.layoutWidget3)
        ...
        self.lab_pathIL2 = QtWidgets.QLabel(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pathIL2 = QtWidgets.QLineEdit(self.layoutWidget3)
        self.pathIL2.setObjectName("pathIL2")
        self.horizontalLayout_7.addWidget(self.pathIL2)
        self.browseIL2 = QtWidgets.QToolButton(self.layoutWidget3)
        ...
        self.lab_portIL2 = QtWidgets.QLabel(self.layoutWidget3)
        self.lab_portIL2.setObjectName("lab_portIL2")
        self.horizontalLayout_8.addWidget(self.lab_portIL2)
        self.portIL2 = QtWidgets.QLineEdit(self.layoutWidget3)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(270, 41, 311, 106))
        ...
        self.lab_auto_launch = QtWidgets.QLabel(self.layoutWidget4)
        ...
        self.lab_start_min = QtWidgets.QLabel(self.layoutWidget4)
        ...
        self.lab_start_headless = QtWidgets.QLabel(self.layoutWidget4)
        ...
        self.rb_master_j = QtWidgets.QRadioButton(self.layoutWidget4)
        ...
        self.tb_pid_j = QtWidgets.QLineEdit(self.layoutWidget4)
        ...
        self.cb_al_enable_j = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_min_enable_j = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_headless_j = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.rb_master_p = QtWidgets.QRadioButton(self.layoutWidget4)
        self.rb_master_p.setObjectName("rb_master_p")
        self.gridLayout_2.addWidget(self.rb_master_p, 2, 0, 1, 1)
        self.tb_pid_p = QtWidgets.QLineEdit(self.layoutWidget4)
        ...
        self.cb_al_enable_p = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_min_enable_p = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_headless_p = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.rb_master_c = QtWidgets.QRadioButton(self.layoutWidget4)
        self.rb_master_c.setObjectName("rb_master_c")
        self.gridLayout_2.addWidget(self.rb_master_c, 3, 0, 1, 1)
        self.tb_pid_c = QtWidgets.QLineEdit(self.layoutWidget4)
        ...
        self.cb_al_enable_c = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_min_enable_c = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.cb_headless_c = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.labelSystem_2.setGeometry(QtCore.QRect(270, 170, 141, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(270, 191, 311, 94))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(268, 10, 311, 19))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.layoutWidget6)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.labelLaunch = QtWidgets.QLabel(self.layoutWidget6)
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        ...
        self.cb_al_enable = QtWidgets.QCheckBox(self.layoutWidget6)
        font = QtGui.QFont()
        font.setBold(False)
