...
class Ui_AdvancedSpringDialog(object):
    def setupUi(self, AdvancedSpringDialog):
        ...
        spacerItem7 = QtWidgets.QSpacerItem(217, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem7)
        self.pb_import = QtWidgets.QPushButton(parent=AdvancedSpringDialog)
        self.pb_import.setObjectName("pb_import")
        self.horizontalLayout_7.addWidget(self.pb_import)
        self.pb_export = QtWidgets.QPushButton(parent=AdvancedSpringDialog)
        self.pb_export.setObjectName("pb_export")
        self.horizontalLayout_7.addWidget(self.pb_export)
    ...
    def retranslateUi(self, AdvancedSpringDialog):
        ...
        self.pb_get_vne.setText(_translate("AdvancedSpringDialog", "Import VNE"))
