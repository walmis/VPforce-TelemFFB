...
class Ui_AdvancedSpringDialog(object):
    def setupUi(self, AdvancedSpringDialog):
        ...
        self.pb_y_reset = StyledButton(parent=self.frame_2)
        ...
        self.pb_x_reset = StyledButton(parent=self.frame)
        ...
        self.pb_import = StyledButton(parent=AdvancedSpringDialog)
        self.pb_import.setObjectName("pb_import")
        self.horizontalLayout_7.addWidget(self.pb_import)
        self.pb_export = StyledButton(parent=AdvancedSpringDialog)
